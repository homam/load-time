...
(function(){
  var ref$, id, odd, Obj, map, concat, filter, each, find, fold, foldr, fold1, zip, head, tail, all, flatten, sum, groupBy, objToPairs, partition, join, unique, sortBy, reverse, empty, bindA, bindA2, mapA, filterA, anyA, allA, findA, sortByA, f1, f2, f3, f4;
  ...
  bindA = function(f, g, x, callback){
    f(x, function(err, fx){
      return callback(err, g(fx));
    });
  };
  bindA2 = curry$(function(f, g){
